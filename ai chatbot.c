//Welcome to AI chatbot in C programming
#include<stdio.h>
#include<conio.h>
#include<string.h>
#include<time.h>
...
{    system("cls");
  ...
  else if(strcmp(user_input,"hi")==0)
  {
      ...
      printf("bot ==> hi friends\n");
      
  }
 else if(strcmp(user_input,"open chrome")==0)
  {
      
      printf("okay friends , opening chrome browser \n");
      system("start chrome");
 ...
 else if(strcmp(user_input,"open notepad")==0)
  {
      ...
      printf("okay friends , opening notepad editor  \n");
   ...
   else   if(strcmp(user_input,"open cmd")==0)
  {
      ...
      printf("okay friends , opening cmd terminal   \n");
      system("start cmd");
